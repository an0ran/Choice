package kr.nodeline.choice.commons

import android.app.Application
import com.kakao.auth.*
import kr.nodeline.choice.commons.di.myDiModule
import kr.nodeline.choice.commons.utils.MySharedPreferences
...
class MyApplication: Application() {
    ...
    private object KakaoSDKAdapter : KakaoAdapter() {
        ...
        override fun getApplicationConfig(): IApplicationConfig {
            return IApplicationConfig { getMyApplicationContext()?.applicationContext!! }
        }
    }
}